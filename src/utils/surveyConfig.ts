...
export const SURVEY_STEPS: SurveyStep[] = [
  ...
  {
    id: "section-3-dislikes-fears",
    title: "Section 3 – Dislikes, Fears & Negative Things",
    questions: [
      {
        id: "dislikes_food_hate",
        label: "Food you absolutely HATE?",
        type: "text",
        required: true,
      },
      {
        id: "dislikes_drink_never",
        label: "Drink you never want to drink?",
        type: "text",
        required: true,
      },
      {
        id: "dislikes_smell_cant_stand",
        label: "Smell you can’t stand?",
        type: "text",
        required: true,
      },
      {
        id: "dislikes_movie_refuse",
        label: "Type of movie you refuse to watch?",
        type: "text",
        required: true,
      },
      {
        id: "dislikes_music_hate",
        label: "Music type you hate?",
        type: "text",
        required: true,
      },
      {
        id: "dislikes_kind_of_people",
        label:
          "Kind of people you dislike the most? (example: liars, show-offs)",
        type: "text",
        required: true,
      },
      {
        id: "dislikes_pet_peeve",
        label: "Biggest pet peeve (thing that annoys you fast)?",
        type: "text",
        required: true,
      },
      {
        id: "dislikes_bf_never_say",
        label: "One thing a boyfriend should NEVER say to you?",
        type: "text",
        required: true,
      },
      {
        id: "dislikes_bf_never_do",
        label: "One thing a boyfriend should NEVER do?",
        type: "text",
        required: true,
      },
      {
        id: "dislikes_biggest_turnoff",
        label: "Biggest turn-off in a guy?",
        type: "text",
        required: true,
      },
      {
        id: "dislikes_jealous_trigger",
        label: "What makes you jealous easily?",
        type: "text",
        required: true,
      },
      {
        id: "dislikes_most_scared_of",
        label: "What are you most scared of? (ghosts, heights, etc.)",
        type: "text",
        required: true,
      },
      {
        id: "dislikes_terrified_animal",
        label: "Animal/insect you are terrified of?",
        type: "text",
        required: true,
      },
      {
        id: "dislikes_place_never_visit",
        label: "Place you never want to visit?",
        type: "text",
        required: true,
      },
      {
        id: "dislikes_weather_season_hate",
        label: "Weather and season you hate the most?",
        type: "text",
        required: true,
      },
      {
        id: "dislikes_makes_cry_easily",
        label: "Something that makes you cry super easily?",
        type: "text",
        required: true,
      },
      {
        id: "dislikes_bad_habit_others",
        label: "Bad habit in others that you can’t tolerate?",
        type: "text",
        required: true,
      },
      {
        id: "dislikes_topic_dont_like",
        label: "Topic you don’t like talking about?",
        type: "text",
        required: true,
      },
      {
        id: "dislikes_worst_gift",
        label: "Worst gift you could receive?",
        type: "text",
        required: true,
      },
      {
        id: "dislikes_ruins_mood",
        label: "Something that ruins your mood instantly?",
        type: "text",
        required: true,
      },
    ],
  ...
  {
    id: "section-4-gossip-tea-style",
    title: "Section 4 – Gossip & Tea Style",
    questions: [
      {
        id: "gossip_like_gossip",
        label: "Do you like to gossip/spill tea?",
        type: "radio",
        required: true,
        options: [
          { value: "A", label: "Yes, I live for drama!" },
          { value: "B", label: "Sometimes, if it’s juicy" },
          { value: "C", label: "Only a little" },
          { value: "D", label: "No, I hate gossip" },
        ],
      },
      {
        id: "gossip_like_others_gossip",
        label: "Do you like others gossip/spill tea?",
        type: "radio",
        required: true,
        options: [
          { value: "A", label: "Yes! I love it" },
          { value: "B", label: "Only if it’s interesting" },
          { value: "C", label: "Depends on my mood" },
          { value: "D", label: "None of my business, hate it" },
        ],
      },
      {
        id: "gossip_who_with",
        label: "Who do you usually gossip with?",
        type: "radio",
        required: true,
        options: [
          { value: "A", label: "My bestie(s)" },
          { value: "B", label: "Group chat" },
          { value: "C", label: "Sister/family" },
          { value: "D", label: "Almost anyone" },
        ],
      },
      {
        id: "gossip_prefer_about",
        label: "You prefer gossip about:",
        type: "radio",
        required: true,
        options: [
          { value: "A", label: "People I know in real life" },
          { value: "B", label: "Celebrities & strangers" },
          { value: "C", label: "Both the same" },
        ],
      },
      {
        id: "gossip_fav_topic_1",
        label: "Your #1 favorite tea topic:",
        type: "radio",
        required: true,
        options: [
          { value: "A", label: "Cute couple/love stories" },
          { value: "B", label: "Someone cheating" },
          { value: "C", label: "Someone getting cheated on" },
          { value: "D", label: "Money & rich/poor drama" },
        ],
      },
      {
        id: "gossip_fav_topic_2",
        label: "Second favorite tea topic:",
        type: "radio",
        required: true,
        options: [
          { value: "A", label: "Secret dating/who likes who" },
          { value: "B", label: "Breakups & revenge" },
          { value: "C", label: "Glow-up or glow-down (looks/weight)" },
          { value: "D", label: "People’s fails & bad luck" },
        ],
      },
      {
        id: "gossip_when_hear_drama",
        label: "When you hear hot drama, you:",
        type: "radio",
        required: true,
        options: [
          { value: "A", label: "Tell everyone immediately" },
          { value: "B", label: "Only tell 1–2 close friends" },
          { value: "C", label: "Keep it to myself" },
        ],
      },
      {
        id: "gossip_send_screenshots",
        label: "Do you send screenshots of messy chats?",
        type: "radio",
        required: true,
        options: [
      ...
      {
        id: "gossip_follow_celebrity_scandals",
        label: "Do you follow celebrity cheating/dating scandals?",
        type: "radio",
        required: true,
        options: [
          { value: "A", label: "Obsessed, I know everything" },
          { value: "B", label: "I see them sometimes" },
          { value: "C", label: "Don’t care" },
        ],
      },
      {
        id: "gossip_follow_tea_pages",
        label: "Do you follow tea/drama pages (TikTok, IG, Twitter)?",
        type: "radio",
        required: true,
        options: [
          { value: "A", label: "Yes, many" },
          { value: "B", label: "A few" },
          { value: "C", label: "No" },
        ],
      },
      {
        id: "gossip_friend_new_bf",
        label: "Your friend gets a new boyfriend. You:",
        type: "radio",
        required: true,
        options: [
          { value: "A", label: "Ask for ALL the details right now" },
          { value: "B", label: "Wait until she tells me" },
          { value: "C", label: "Not really interested" },
        ],
      },
      {
        id: "gossip_friend_being_cheated",
        label: "If your friend is being cheated on, you:",
        type: "radio",
        required: true,
        options: [
          { value: "A", label: "Tell her straight away" },
          { value: "B", label: "Drop big hints" },
          { value: "C", label: "Stay quiet" },
        ],
      },
      {
        id: "gossip_makes_you_feel",
        label: "Gossip makes you feel:",
        type: "radio",
        required: true,
        options: [
          { value: "A", label: "Excited and happy" },
          { value: "B", label: "Entertained but a bit guilty" },
          { value: "C", label: "Bad, I don’t like it" },
        ],
      },
      {
        id: "gossip_prefer_story_type",
        label: "You prefer:",
        type: "radio",
        required: true,
        options: [
          { value: "A", label: "Sweet love stories" },
          { value: "B", label: "Messy cheating & revenge stories" },
          { value: "C", label: "Both" },
        ],
      },
      {
        id: "gossip_keep_secret",
        label: "Can you keep a secret if someone says “don’t tell”?",
        type: "radio",
        required: true,
        options: [
          { value: "A", label: "Yes, 100%" },
          { value: "B", label: "Usually… but maybe tell one person" },
          { value: "C", label: "No, I will spill" },
        ],
      },
      {
        id: "gossip_how_long_story",
        label: "How long can you talk about one juicy story?",
        type: "radio",
        required: true,
        options: [
          { value: "A", label: "5–10 minutes" },
          { value: "B", label: "30–60 minutes" },
          { value: "C", label: "Hours, I never stop" },
        ],
      },
      {
        id: "gossip_reread_old_chats",
        label: "Do you re-read old drama chats?",
        type: "radio",
        required: true,
        options: [
          { value: "A", label: "Yes, all the time" },
          { value: "B", label: "Sometimes" },
          { value: "C", label: "Never" },
        ],
      },
      {
        id: "gossip_most_about",
        label: "You gossip most about:",
        type: "radio",
        required: true,
        options: [
          { value: "A", label: "Friends/classmates" },
          { value: "B", label: "Co-workers" },
          { value: "C", label: "Ex-boyfriends & their new girls" },
          { value: "D", label: "Random people online" },
        ],
      },
      {
        id: "gossip_cheated_on_feel",
        label: "When someone gets cheated on, you feel:",
        type: "radio",
        required: true,
        options: [
          { value: "A", label: "“They deserved it”" },
          { value: "B", label: "Sorry for them" },
          { value: "C", label: "It’s entertaining" },
        ],
      },
      {
        id: "gossip_like_tea_type",
        label: "You like tea that is:",
        type: "radio",
        required: true,
        options: [
          { value: "A", label: "Super messy and chaotic" },
          { value: "B", label: "Romantic and cute" },
          { value: "C", label: "About money/status" },
        ],
      },
      {
        id: "gossip_overall_you_are",
        label: "Overall, you are:",
        type: "radio",
        required: true,
        options: [
          { value: "A", label: "Queen of tea" },
          { value: "B", label: "Normal gossip girl" },
          { value: "C", label: "Innocent, barely gossip" },
        ],
      },
    ],
  },
