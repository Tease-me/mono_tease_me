...
def _internal_email_when_omitted(telegram_id: int) -> str:
    """Synthetic unique value for users.email (NOT NULL) when client omits email — no DB migration."""
...
async def preregister_mjpromoter_user(
    ...
    stored_email = (
        _internal_email_when_omitted(data.telegram_id)
