...
class Message(Base):
    ...
    conversation_id: Mapped[str | None] = mapped_column(
        ForeignKey("calls.conversation_id"), nullable=True
    )
...
class CallRecord(Base):
    ...
    is_adult_call: Mapped[bool] = mapped_column(
        Boolean,
        nullable=False,
        default=False,
        server_default="false",
    )
    adult_character_id: Mapped[int | None] = mapped_column(Integer, nullable=True)
    ...
    __table_args__ = (Index("idx_calls_user_created", "user_id", "created_at"),)
